...
public class StringManipulationsTKRR {
...
*/
       ...
       // if (number<300 || number>1200){System.out.println("Harika Sayi");}//Harika Sayi
        ...
        //if (number%2!=0){System.out.println("Tek");} else {System.out.println("Cift");}

        // Ex : Verilen bir sayinin negatif mi ,
        // pozitif mi , notr mu oldugunu soyleyen kodu yaziniz
        //int a = 0;
        //if (a<0){System.out.println("negatif");}
        //else if (a==0) {System.out.println("notr");}
