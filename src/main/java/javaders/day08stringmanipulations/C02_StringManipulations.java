...
import java.util.Scanner;
         ...
         */
                ...
                System.out.println("Lutfen Mail Adresinizi Asagidaki kurallara gore giriniz\n" +
                        "       i)mail adresi \"gmail\" icermeli\n" +
                        "       ii)Space characteri mail'de olmamali\n" +
                        "       iii)mail adresinde buyuk harf olmamali\n" +
                        "       iv)En az bir tane noktalama isareti bulunmali  ");
                ...
                boolean first1 = mail.contains("gmail");
                boolean second1 =! mail.contains(" ");
                boolean third1 = mail.replaceAll("[a-zA-Z0-9]", "").replaceAll("[\\p{Punct}]", "").length() == 0;
                boolean fourtth = mail.replaceAll("[a-zA-Z0-9]","").length()>0;

                System.out.println(first1 && second1 && third1 && fourtth);
